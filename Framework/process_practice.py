...
async def process_leave_end(member: discord.Member, voice_state: discord.VoiceState):
    ...
    if str(voice_state.channel.id) in var_config.practicemap[str(voice_state.channel.guild.id)].keys() and var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id)] == str(member.id):
        # get text channel associated with the voice channel that user left from
        text_channel = voice_state.channel.guild.get_channel(int(var_config.broadcastchs[str(voice_state.channel.guild.id)][str(voice_state.channel.id)]))
        ...
        time_practiced_seconds = time_utils.time_practiced_seconds(voice_state.channel.guild.id, voice_state.channel.id)
        ...
        # check if user practicing has indicated the piece they're currently practicing
        if (str(voice_state.channel.id) + 'piece') in var_config.practicemap[str(voice_state.channel.guild.id)].keys():
            # update last rep with their current practice piece
            mongo_utils.update_user_record(var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id)], str(voice_state.channel.guild.id), time_practiced_seconds,
                                           var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id) + 'piece'])
        else:
            # update last rep with None
            mongo_utils.update_user_record(var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id)], str(voice_state.channel.guild.id), time_practiced_seconds,
                                           "None")
        # updating server total time
        ...
        del var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id)]
        del var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id) + 'start_time']
        if str(voice_state.channel.id) + 'piece' in var_config.practicemap[str(voice_state.channel.guild.id)].keys():
            del var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id) + 'piece']
        ...
        if str(voice_state.channel.id) + 'excused' in var_config.practicemap[str(voice_state.channel.guild.id)].keys() and var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id) + 'excused']:
        ...
        if str(voice_state.channel.id) + 'piece' in var_config.practicemap[str(voice_state.channel.guild.id)].keys():
            del var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id) + 'excused']
    ...
    # check if channel's excused key exists in practicemap, and if the user that left was excused in the voice channel they were in
        ...
        var_config.practicemap[str(voice_state.channel.guild.id)][str(voice_state.channel.id) + 'excused'].remove(member.id)
